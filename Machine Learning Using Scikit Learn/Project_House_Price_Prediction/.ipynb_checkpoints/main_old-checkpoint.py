...
# print(f"The root mean squared error for Linear Regression is {dec_rmses}")
...
# ran_rmse = root_mean_squared_error(housing_label, ran_preds)
ran_rmses = -cross_val_score(ran_reg, housing_prepared, housing_label, scoring="neg_root_mean_squared_error", cv=10)
# print(f"The root mean squared error for Linear Regression is {ran_rmse}")
